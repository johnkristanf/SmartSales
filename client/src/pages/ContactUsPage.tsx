...
function ContactUsPage(){
    ...
    return(
        ...
        <section className="bg-blue-50 dark:bg-slate-800" id="contact">
            <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-10">
                <div className="mb-4">
                    ...
                    <div className="grid md:grid-cols-2">
                        <div className="h-full pr-6">
                            <p className="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                                ...
                                for technical assistance, or suggestions for improvement, our 
                                team is eager to hear from you. As experts in data analysis, we empower 
                                businesses to make informed, data-driven decisions that drive growth and 
                                efficiency. Reach out to discover how we can transform your data into 
                                actionable insights.
                            </p>
                            <ul className="mb-6 md:mb-0">
                                ...
                                <li className="flex">
                                    ...
                                    <div className="ml-4 mb-8">
                                        ...
                                        <p className="text-gray-600 dark:text-slate-400">Mail: smartsales@gmail.com</p>
                                    </div>
                                </li>
                                <li className="flex">
                                    <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
